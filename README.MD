...
Once every 5 minutes, one repository will be fetched in the background, and the icon beside repository name will reflect 
...
if it is showing the processing screen or fetching changes in the background. 
