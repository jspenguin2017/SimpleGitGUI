...
`F5` can be used to reload the renderer process when it is not busy. The window cannot be closed when the renderer is busy, 
but you can always press `F12` to bring up DevTools to fix it if it is stuck. 
